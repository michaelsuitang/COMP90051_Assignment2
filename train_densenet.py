...
from models import DensenetEncoder, Decoder   
from preprocessing import ImageDataset, transform
...
def tune_densenet_with_bootstrap(filenames, device, B=3):
    # Step 1: lr
    ...
    print(f"\n Final best params for Densenet: lr={best_lr}, betas={best_betas}, val loss={best_loss:.4f}")
